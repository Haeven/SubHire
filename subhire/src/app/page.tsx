        ...
        <div className="grid gap-6 sm:grid-cols-[1fr,1fr] lg:grid-cols-[1fr,400px] xl:grid-cols-[1fr,600px]">
          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tighter text-black dark:text-gray-400">
              ...
              <p className="max-w-[600px] text-gray-500 text-lg sm:text-xl md:text-2xl lg:text-xl dark:text-gray-400">
                The AI-powered platform helping you find and manage contracts with verified professionals.
              </p>
            </div>
